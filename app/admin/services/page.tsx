                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-black/20 p-4 rounded-xl border border-white/5">
                            ...
                            <div className="space-y-2 text-sm">
                                <p className="flex justify-between border-b border-white/5 pb-2"><span className="text-white/50">اسم المزود:</span> <span className="font-bold">{getProviderName(selectedService)}</span></p>
                                <p className="flex justify-between border-b border-white/5 pb-2"><span className="text-white/50">البريد الإلكتروني:</span> <span className="font-mono">{getProviderEmail(selectedService)}</span></p>
